...
public class Main {
    public static void main(String[] args) {
        ...
        movieCollection.addItem("Y001", new Movie("The Legend of Kazuma Kiryu", "Kazuma
                Kiryu", 2005));
                movieCollection.addItem("Y002", new Movie("Mad Dog of Shimano", "Goro Majima",
                        2007));
        movieCollection.addItem("Y003", new Movie("Fall of Nishikiyama", "Akira
                Nishikiyama", 2005));
                customerRegistry.addItem("C001", new Customer("Kazuma Kiryu", "Dragon of
                        Dojima"));
                        customerRegistry.addItem("C002", new Customer("Goro Majima", "Mad Dog of
                                Shimano"));
